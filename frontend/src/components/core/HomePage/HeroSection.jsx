...
const HeroSection = () => {
  ...
  return (
    <>
      <Spotlight />
      <div className='md:h-[100vh] w-full relative flex items-center flex-col'>
        {/* Video Background */}
        <video 
          className="absolute inset-0 w-full h-full object-cover z-0" 
          src="https://cdn.pixabay.com/video/2015/10/03/899-141310139_large.mp4" 
          autoPlay 
          loop 
          muted 
          playsInline
        ...
        <Link to={"/mocktest"} className="bg-zinc-900 no-underline mt-20 group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block z-20">
        ...
        >
          We Know That <br />
          Together <i>
            <AnimatedText texts={['We', 'Yes', 'We']} interval={1500} />
          </i> Can<br />
        ...
        <motion.div
          ...
          whileInView={'show'}
          viewport={{ once: false, amount: 0.1 }}
          className='mt-2 w-[80%] text-center text-base lg:text-lg font-bold text-slate-200 z-20'
        >
        ...
        {token ?
          <div className='flex mt-10 flex-col z-20'>
          ...
          :
          <div className=' mt-10 flex gap-x-4 z-20'>
            <Link to={"/login"}>
        ...
        <div className="w-full mt-10 md:mt-20 overflow-hidden z-20"></div>
      </div>
    </>
  )
}
