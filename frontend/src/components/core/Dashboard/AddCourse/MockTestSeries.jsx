      ...
      <div className="flex w-full items-start gap-x-8">
            ...
            <form onSubmit={status === 'draft' ? handleDraft : handleSubmit} className="space-y-8">
              ...
              <div className="rounded-2xl border border-line bg-surface p-8 shadow-2xl space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-surface border border-line text-fg placeholder-muted focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <label htmlFor="thumbnail" className="block text-sm font-medium text-fg">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-page border border-line text-fg placeholder-muted focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-elevated file:text-fg hover:file:bg-page cursor-pointer"
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-fg">Mock Tests in Series</h2>
                  <button
                    type="button"
                    onClick={addMockTest}
                ...
                {mockTests.length === 0 ? (
                  <div className="rounded-2xl border-2 border-dashed border-line bg-page p-12 text-center">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <div>
                        <p className="text-muted text-lg font-medium">No mock tests added yet</p>
                        <p className="text-subtle text-sm mt-1">Click "Add Mock Test" to get started</p>
                      </div>
                    </div>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {mockTests.map((test, index) => (
                      <div key={index} className="rounded-2xl border border-line bg-surface p-6 shadow-2xl relative">
                        <button
                          type="button"
                        ...
                        <h3 className="text-lg font-semibold text-fg mb-4">Mock Test #{index + 1}</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-line">
                ...
                <button
                  ...
                  onClick={handleDraft}
                  disabled={isSubmitting}
                  className="flex-1 py-3 px-6 rounded-lg font-semibold text-fg bg-elevated hover:bg-elevated transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Save as Draft
                </button>
              </div>
        ...
        <div className="sticky top-10 hidden lg:block max-w-[420px] flex-1 rounded-xl border border-line bg-surface p-8 shadow-2xl backdrop-blur-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-xl font-semibold text-fg">Creation Tips</p>
          </div>
