        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <div className="max-w-sm mx-auto px-4">
              <p className="text-xs sm:text-sm text-gray-600 leading-relaxed text-center">
                Join thousands of students mastering their skills with expert-led courses and comprehensive test preparation
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2.5 sm:space-y-3 mb-8 sm:mb-10 px-4 sm:px-0">
            <div className="flex items-start gap-3 justify-center">
              ...
              <p className="text-xs text-gray-600 text-center sm:text-left">Access premium courses and mock tests</p>
            </div>
            <div className="flex items-start gap-3 justify-center">
              <div className="mt-1 w-1 h-1 rounded-full bg-gray-600 flex-shrink-0"></div>
              <p className="text-xs text-gray-600 text-center sm:text-left">Track your progress with detailed analytics</p>
            </div>
            <div className="flex items-start gap-3 justify-center">
              <div className="mt-1 w-1 h-1 rounded-full bg-gray-600 flex-shrink-0"></div>
              <p className="text-xs text-gray-600 text-center sm:text-left">Learn at your own pace, anytime, anywhere</p>
            </div>
          </div>
