...
const Home = () => {
  ...
  return (
    <div className='overflow-hidden w-[100vw]'>
      ...
      <a href='https://t.me/awakeningclasses3103'
...
>
  <FaTelegram size={'16'} className='bg-white rounded-full text-[#24A1DE] '/>
</a>


<a href='https://whatsapp.com/channel/0029Van0bFDDDmFZjhOoX03N'
...
>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-3 h-3" fill="#25D366"> {/* WhatsApp green color */}
...
<a href='https://www.instagram.com/awakeningclasses?igsh=bXo2MXllODRmandr&utm_source=qr'
...
>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 169.063 169.063" className="w-3 h-3">
    <defs>
